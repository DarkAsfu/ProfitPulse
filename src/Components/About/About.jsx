        ...
        <>
            ...
            <div className="w-10/12 mx-auto md:grid grid-cols-2 items-center py-10">
                ...
                <div className=" mt-4">
                    ...
                    <p className="text-[17px]">ProfitPulsar is a leading affiliate network. We always focus on onboarding the best converting, newest and highest paying offers within the industry. We are also known for our excellent support. The owner of ProfitPulsar used to be an affiliate for over 4 years. We will personally help you improve your conversion rate!</p>
